...
function M.handle_anthropic_spec_data(data_stream, extmark_id, event_state)
	if event_state == "content_block_data" then
...
function M.invoke_llm_and_stream_into_editor(opts, make_curl_args_fn, handle_data_fn)
	...
	vim.notify("args: " .. vim.inspect(args), vim.log.levels.INFO)
	...
	vim.api.nvim_set_keymap("n", "<Esc>", ":doautocmd User LLM_Escape", { noremap = true, silent = true })
	return active_job
end
